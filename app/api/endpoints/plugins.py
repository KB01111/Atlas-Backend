...
async def create_plugin_config(
    config: PluginConfigurationCreate, user_id: str = Depends(get_current_user_id)
):
...
async def get_plugin_config(
    config_id: str, user_id: str = Depends(get_current_user_id)
):
...
async def list_plugin_configs(user_id: str = Depends(get_current_user_id)):
